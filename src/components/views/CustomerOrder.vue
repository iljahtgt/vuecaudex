...
<div class="text-center mx-auto col-md-7">
        ...
        <ValidationObserver v-slot="{ invalid }" tag="form">
          <form @submit.prevent="createOrder" class="w-75 mx-auto">
            ...
            <div class="text-right">
                <router-link to="/customer/shop" class="btn btn-success">回上一頁</router-link>
    ...
    <div v-if="cart" class="col-md-5 border shadow p-3 h-50">
      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="item in cart.carts" :key="item.id">
            <td>
              <img :src="item.product.imageUrl" width="50" height="50" alt="" />
            </td>
            <td>
              {{ item.product.title }}
      ...
      <div class="input-group mb-5 input-group-sm w-50 div-right">
        <input
          type="text"
          class="form-control"
          v-model="coupon_code"
